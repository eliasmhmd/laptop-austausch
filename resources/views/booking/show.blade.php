...
@section('content')
    <div class="mx-auto max-w-lg">
        <div class="rounded-xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            @if ($booking->isActive())
                {{-- Hinweis: Termin notieren oder in den Kalender übernehmen --}}
                <div class="mt-6 flex gap-2 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-sm text-blue-800">
                    ...
                    <span>
                        Bitte <strong>notieren Sie sich diesen Termin</strong> – oder fügen Sie ihn
                        unten über „Zum Kalender hinzufügen" direkt Ihrem Kalender hinzu.
                    </span>
                </div>
